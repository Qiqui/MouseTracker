...
string connection = builder.Configuration.GetConnectionString("MouseTracker");
builder.Services.AddDbContext<DatabaseContext>(options => options.UseSqlServer(connection));
builder.Services.AddTransient<IMouseMovementRepository, MouseMovementRepository>();
